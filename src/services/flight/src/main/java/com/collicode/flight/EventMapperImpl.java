...
import com.collicode.buildingblocks.contracts.flight.*;
...
import com.collicode.flight.airports.features.createairport.AirportCreatedDomainEvent;
import com.collicode.flight.airports.features.createairport.CreateAirportMongoCommand;
import com.collicode.flight.flights.features.createflight.CreateFlightMongoCommand;
import com.collicode.flight.flights.features.createflight.FlightCreatedDomainEvent;
import com.collicode.flight.flights.features.deleteflight.DeleteFlightMongoCommand;
import com.collicode.flight.flights.features.deleteflight.FlightDeletedDomainEvent;
import com.collicode.flight.flights.features.updateflight.FlightUpdatedDomainEvent;
import com.collicode.flight.flights.features.updateflight.UpdateFlightMongoCommand;
import com.collicode.flight.seats.features.createseat.CreateSeatMongoCommand;
import com.collicode.flight.seats.features.createseat.SeatCreatedDomainEvent;
import com.collicode.flight.seats.features.reserveseat.ReserveSeatMongoCommand;
import com.collicode.flight.seats.features.reserveseat.SeatReservedDomainEvent;
